  ...
  return (
    <main className="flex items-center h-screen relative bg-cover bg-[url('/Assets/bg-explosion.png')]">
      ...
      <div className="flex flex-col gap-3 z-[10] pl-40 pt-20">
        ...
        <p className="text-[16px] text-gray-200 md:text-gray-400 mb-10 md:pb-2 max-w-[400px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam incidunt debitis est deleniti ea voluptatem magni obcaecati eaque quia perspiciatis error quibusdam placeat, aperiam numquam rem minus, fuga optio dolores.</p>
